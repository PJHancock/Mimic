...
const flowboxData: Record<string, FlowboxInfo> = {
  ...
  postproc: { title: '📋 POST PROCESSING & SKILL GRAPH', technical: 'Filter noise, smooth predictions, and build skill state transition graph', desc: 'Filter predictions and generate skill sequence graph from state probabilities. Smooth temporal sequences and extract transition patterns for task planning. Full pipeline visualization video available in results/IMG_2013_final/visualization/sidebyside.mp4', skills: ['Signal processing', 'Graph algorithms', 'Sequence planning', 'State transitions'] },
